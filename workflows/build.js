...
function developPrompt(lane) {
  ...
  return [
    ...
    'directory you own in the same pass, and where an AGENTS.md you touch has no sibling CLAUDE.md,',
    `create it (→ ${conventionsDir}/15-doc-tracking.md §1). Leave nothing uncommitted: no changed tracked`,
    'file and no untracked file under your owned paths. Report every criterion below afresh, red included — nothing',
