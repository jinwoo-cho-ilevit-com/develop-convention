...
|---|---|---|
| Module | diff + changed files | correctness, edge cases, error handling, a criterion with no check, a bug fix whose commit carries no before/after reproduction, a test the sample run already covers |
