...
전체 컨벤션: `~/Codes/develop-convention` — 작업 유형에 해당하는 문서의 "핵심 규칙"을 따른다 (문서 맵은 그 저장소의 README.md).
...
- provider API 코드 작성/수정 전: `~/Codes/develop-convention/conventions/12-docs-reference.md`의 해당 provider 공식 문서를 fetch해 확인
