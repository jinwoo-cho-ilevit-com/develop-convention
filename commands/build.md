...
6. Run the whole-project completion condition from `PLAN.md` — every lane's criteria, every boundary contract, and the end-to-end condition. A failure stops here as step 1 does: report it, do not close the lanes.
